...
func init() {
	...
	rootCmd.PersistentFlags().StringVarP(&Novel.Cover, "cover", "c", "cover.png", "封面路径")
	...
	rootCmd.PersistentFlags().BoolVarP(&isDownload, " is_download", "d", true, "书籍来源是否下载")
}
